...
export function DashboardStats({ totalDecks, totalCards }: DashboardStatsProps) {
  return (
    <div className={styles.stats}>
      ...
      <div className={styles.statCard}>
        <div className={styles.statValue}>{totalDecks > 0 ? Math.round(totalCards / totalDecks) : 0}</div>
