      ...
      <div className={styles.formRow}>
        <div className={styles.formGroup}>
          ...
          <p className={styles.helpText}>
            {difficulty === 'beginner' && 'Simple concepts with clear explanations'}
            {difficulty === 'intermediate' && 'Moderate complexity with detailed answers'}
            {difficulty === 'advanced' && 'Complex topics with in-depth analysis'}
          </p>
        </div>
